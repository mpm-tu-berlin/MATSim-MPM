...
1 m / 0.08 s = 12.5 m/s = 45 km/h). Mit 100-m-Segmenten betraegt der
Rundungsfehler bei 83 km/h noch < 0.5 % (10.84 s / 0.04 s = 271 Schritte).
...
SZENARIEN = [
    {
        ...
        "ausgabe": (
            ...
            r"\VECTO_Longhaul\longhaul_network_100m.xml.gz"
        ),
        "name": "LongHaul",
    },
    {
        ...
        "ausgabe": (
            r"C:\Users\Tobias\IdeaProjects\MATSim-MPM\scenarios"
            r"\VECTO_RegionalDelivery\regional_delivery_network_100m.xml.gz"
        ),
...
# 100 m bei 83 km/h = 23.06 m/s → Fahrzeit 4.34 s = ~108 Zeitschritte → Fehler < 1 %.
MIN_SEGMENT_LENGTH_M = 100
